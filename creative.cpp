...
static int32_t Inventory_setupDefault_FillingContainer_addItem_call_injection(unsigned char *filling_container, ItemInstance *item_instance) {
    ...
    diamondSword_instance->count = 250;
    ...
    mushroomStew_instance->count = 250;
    ...
    cookedChicken_instance->count = 250;
    ...
    diamondHelm_instance->count = 250;
    ...
    diamondChest_instance->count = 250;
    ...
    diamondBoot_instance->count = 250;
    ...
    doubleStoneSlab_instance->count = 250;
    ...
    activeFurnace_instance->count = 250;
    ...
    activeRedstoneOre_instance->count = 250;
    ...
    woodPickaxe_instance->count = 250;
    ...
    stoneShovel_instance->count = 250;
    ...
    stonePickaxe_instance->count = 250;
    ...
    diamondShovel_instance->count = 250;
    ...
    diamondPickaxe_instance->count = 250;
    ...
    goldPickaxe_instance->count = 250;
    ...
    leatherShirt_instance->count = 250;
    ...
    leatherPants_instance->count = 250;
    ...
    leatherBoots_instance->count = 250;
    ...
    cookedGoose_instance->count = 250;
